...
*/
        ...
        vSeeds.emplace_back("seed.checkbug.com");
        vSeeds.emplace_back("seed2.checkbug.com");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,20); // Magi: addresses begin with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);  // Magi: addresses begin with '9'
